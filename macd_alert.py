...
# Configuration de l'email d'alerte à partir des variables d'environnement
...
PRICE_ALERT_THRESHOLD = 2.50  # Modifier ce niveau de prix selon vos besoins
...
def get_historical_data():
    ...
    data = response.json()
    if 'data' in data and 'attributes' in data['data'] and 'chart' in data['data']['attributes'] and 'points' in data['data']['attributes']['chart']:
        ...
        raise ValueError("Structure inattendue des données API.")
